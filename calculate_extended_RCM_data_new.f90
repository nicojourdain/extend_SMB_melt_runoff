...
file_out_smb  = '/scratchu/njourdain/RCMs_PROTECT/MAR-<gcm>_asmb_2101-2300_<scenar>_regrid_04000m_EXTENDED.nc'
file_out_me  = '/scratchu/njourdain/RCMs_PROTECT/MAR-<gcm>_ame_2101-2300_<scenar>_regrid_04000m_EXTENDED.nc'
file_out_ru  = '/scratchu/njourdain/RCMs_PROTECT/MAR-<gcm>_aru_2101-2300_<scenar>_regrid_04000m_EXTENDED.nc'
...
status = NF90_PUT_ATT(fidoutSMB,NF90_GLOBAL,"history","Created by N. Jourdain using calculate_extended_RCM_data_new.f90"); call erreur(status,.TRUE.,"put_att_GLOBAL_ID")
...
status = NF90_PUT_ATT(fidoutMLT,NF90_GLOBAL,"history","Created by N. Jourdain using calculate_extended_RCM_data_new.f90"); call erreur(status,.TRUE.,"put_att_GLOBAL_ID")
...
status = NF90_PUT_ATT(fidoutRUN,NF90_GLOBAL,"history","Created by N. Jourdain using calculate_extended_RCM_data_new.f90"); call erreur(status,.TRUE.,"put_att_GLOBAL_ID")
