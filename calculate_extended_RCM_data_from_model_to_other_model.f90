...
status = NF90_PUT_ATT(fidoutSMB,NF90_GLOBAL,"history","Created by N. Jourdain using calculate_extended_RCM_data_from_model_to_other_model.f90")
...
status = NF90_PUT_ATT(fidoutMLT,NF90_GLOBAL,"history","Created by N. Jourdain using calculate_extended_RCM_data_from_model_to_other_model.f90")
call erreur(status,.TRUE.,"put_att_GLOBAL_ID")
...
status = NF90_PUT_ATT(fidoutRUN,NF90_GLOBAL,"history","Created by N. Jourdain using calculate_extended_RCM_data_from_model_to_other_model.f90")
call erreur(status,.TRUE.,"put_att_GLOBAL_ID")
